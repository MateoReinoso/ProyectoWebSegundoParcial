        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-0 text-gray-800">Detalle reunión</h1>
                    <!-- Begin Page Content -->
                    <div class="container-fluid">
                                    ...
                                    <form action="#" class="user">
                                        <div class="border p-5 form">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control" id="fecha" name="fecha"
                                                        disabled value="" min="2020-01-01" max="2022-12-31" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="time" disabled class="form-control" id="hora"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select disabled class="form-control" id="asignatura">
