...
if(isset($_POST["modificar"])){
    $alumno=$docenteService->findByPKAlumnoAsistencia($_POST["selectStudents"]);
    if($alumno!=null){
        if($alumno["FECHA"]==$_POST["fecha"]){
            $docenteService->updateAsistenciaAlumno($_POST["selectState"], $_POST["selectStudents"]);
        }else{
            $message='true';
        } 
    }else{
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-0 text-gray-800">Actualizar asistencia</h1> <br>
                    <!-- Begin Page Content -->
                    <div class="container-fluid">
                        <div style="display: flex;align-items: center;justify-content: center;">
                            <div class="abs-center">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <form action="modificarAsistencia.php" method="POST" class="user">
                                        <div class="container text-content-center">
                                            ...
                                            if(isset($_POST["modificar"])){
                                            if($message=='true'){?>
                                            <p style="color:red;">*Asistencia no se encuentra registrada</p>
                                            <?php }}?>
                                        </div>
                                        <div class="py-4"></div>
                                        <div class="form-group row" style="justify-content: center;">
                                            ...
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                <input class="btn btn-primary btn-user btn-block" name="modificar"
