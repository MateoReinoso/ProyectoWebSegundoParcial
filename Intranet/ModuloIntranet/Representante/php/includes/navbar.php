<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          </h2>Unidad Educativa Margaret Hamilton</h2>
          <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    ...
                    <span class="font-weight-bold">Nueva tarea de la asignatura</span>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div class="font-weight-bold">
                    <div class="text-truncate">Hola chicos, no olvidar que el jueves presentan sus proyectos. Saludos
                    </div>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="../Docente/index.php">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Docente
                </a>
                <a class="dropdown-item" href="../Directivo/index.php">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Directivo
                </a>
                <a class="dropdown-item" href="../Alumno/index.php">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Alumno
                </a>
                ...
                <a class="dropdown-item" href="../LogIn/login.php"> Salir</a>
              </div>
            </li>
